...
HD_PWD='D:/dp/zcu106/tpg_dp_live/vivado/tpg_dp_live/tpg_dp_live.runs/mpsoc_preset_v_proc_ss_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mpsoc_preset_v_proc_ss_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mpsoc_preset_v_proc_ss_0_0.tcl
