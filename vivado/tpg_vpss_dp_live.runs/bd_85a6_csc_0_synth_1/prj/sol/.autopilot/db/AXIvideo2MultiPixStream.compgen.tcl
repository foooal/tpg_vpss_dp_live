...
eval "cg_default_interface_gen_dc { \
    id 83 \
    name HwReg_width_c23 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_width_c23 \
    op interface \
    ports { HwReg_width_c23_din { O 12 vector } HwReg_width_c23_num_data_valid { I 2 vector } HwReg_width_c23_fifo_cap { I 2 vector } HwReg_width_c23_full_n { I 1 bit } HwReg_width_c23_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 84 \
    name HwReg_height_c29 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_height_c29 \
    op interface \
    ports { HwReg_height_c29_din { O 12 vector } HwReg_height_c29_num_data_valid { I 2 vector } HwReg_height_c29_fifo_cap { I 2 vector } HwReg_height_c29_full_n { I 1 bit } HwReg_height_c29_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 85
set RegSliceName bd_85a6_csc_0_regslice_both
set RegSliceInstName bd_85a6_csc_0_regslice_both_U
set CoreName ap_simcore_bd_85a6_csc_0_regslice_both
