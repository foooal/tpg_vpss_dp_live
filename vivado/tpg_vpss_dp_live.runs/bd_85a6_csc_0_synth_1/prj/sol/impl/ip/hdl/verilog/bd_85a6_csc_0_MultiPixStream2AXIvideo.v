...
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_start;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_done;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_idle;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_ready;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_stream_out_vresampled_read;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_m_axis_video_TREADY;
wire   [23:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_m_axis_video_TDATA;
wire    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_m_axis_video_TVALID;
wire   [2:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_m_axis_video_TKEEP;
wire   [2:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_m_axis_video_TSTRB;
wire   [0:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_m_axis_video_TUSER;
wire   [0:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_m_axis_video_TLAST;
wire   [0:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_m_axis_video_TID;
wire   [0:0] grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_m_axis_video_TDEST;
...
reg    grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_start_reg;
wire    ap_CS_fsm_state3;
wire   [0:0] icmp_ln617_fu_171_p2;
reg   [11:0] i_fu_84;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 5'd1;
#0 grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_start_reg = 1'b0;
end
...
bd_85a6_csc_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_151(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .d(WidthOut_dout),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln617_fu_171_p2 == 1'd0))) begin
            grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_start_reg <= 1'b1;
        end else if ((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_ready == 1'b1)) begin
            grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((1'b0 == WidthOut_empty_n) | (1'b0 == Height_empty_n) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_fu_84 <= 12'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln617_fu_171_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        sof_reg_106 <= 1'd1;
    end else if (((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
        sof_reg_106 <= 1'd0;
    end
end
...
always @ (*) begin
    if ((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_done == 1'b0)) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln617_fu_171_p2 == 1'd1))) begin
        ...
        ap_ST_fsm_state4 : begin
            if (((grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state4))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state4;
            end
...
assign grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_start = grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_ap_start_reg;

assign grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_m_axis_video_TREADY = (m_axis_video_TREADY_int_regslice & ap_CS_fsm_state4);

assign i_2_fu_176_p2 = (i_fu_84 + 12'd1);

assign icmp_ln617_fu_171_p2 = ((i_fu_84 == rows_reg_199) ? 1'b1 : 1'b0);

assign m_axis_video_TVALID = regslice_both_m_axis_video_V_data_V_U_vld_out;

assign m_axis_video_TVALID_int_regslice = grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_619_2_fu_120_m_axis_video_TVALID;

assign sub_fu_162_p2 = ($signed(grp_reg_unsigned_short_s_fu_151_ap_return) + $signed(12'd4095));

endmodule //bd_85a6_csc_0_MultiPixStream2AXIvideo
