...
set IPName      "v_csc"
set Version     "1.1"
set DisplayName "V_csc"
set Revision    "2113823583"
...
set xo_kernel_name "v_csc"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/dp/zcu106/tpg_dp_live/vivado/tpg_dp_live/tpg_dp_live.runs/bd_85a6_csc_0_synth_1/prj/sol"
set debug_dir "D:/dp/zcu106/tpg_dp_live/vivado/tpg_dp_live/tpg_dp_live.runs/bd_85a6_csc_0_synth_1/prj/sol/.debug"
set xo_hls_files_dir ""
set hdl_module_list {bd_85a6_csc_0_flow_control_loop_pipe_sequential_init
...
## Variables
set Top "bd_85a6_csc_0_v_csc"
set TopNoPrefix "v_csc"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 INTERRUPT R 0 "Control signal Register for 'interrupt'." } { 10 22 RESERVED_3 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{0 1 CHAN0_INT_EN RW 0 {Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled.}} {1 1 CHAN1_INT_EN RW 0 {Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{0 1 CHAN0_INT_ST RTOW 0 {Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 interrupt, 1 = Channel 0 interrupt.}} {1 1 CHAN1_INT_ST RTOW 0 {Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 interrupt, 1 = Channel 1 interrupt.}} {2 30 RESERVED_0 R 0 {Reserved.  0s on read.}}}} {0x10 InVideoFormat W 0x0 "Data signal of InVideoFormat" {{0 8 InVideoFormat W 0 "Bit 7 to 0 of InVideoFormat"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 OutVideoFormat W 0x0 "Data signal of OutVideoFormat" {{0 8 OutVideoFormat W 0 "Bit 7 to 0 of OutVideoFormat"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 width W 0x0 "Data signal of width" {{0 16 width W 0 "Bit 15 to 0 of width"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 height W 0x0 "Data signal of height" {{0 16 height W 0 "Bit 15 to 0 of height"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 ColStart W 0x0 "Data signal of ColStart" {{0 16 ColStart W 0 "Bit 15 to 0 of ColStart"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 ColEnd W 0x0 "Data signal of ColEnd" {{0 16 ColEnd W 0 "Bit 15 to 0 of ColEnd"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 RowStart W 0x0 "Data signal of RowStart" {{0 16 RowStart W 0 "Bit 15 to 0 of RowStart"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 RowEnd W 0x0 "Data signal of RowEnd" {{0 16 RowEnd W 0 "Bit 15 to 0 of RowEnd"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 K11 W 0x0 "Data signal of K11" {{0 16 K11 W 0 "Bit 15 to 0 of K11"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 K12 W 0x0 "Data signal of K12" {{0 16 K12 W 0 "Bit 15 to 0 of K12"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 K13 W 0x0 "Data signal of K13" {{0 16 K13 W 0 "Bit 15 to 0 of K13"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 K21 W 0x0 "Data signal of K21" {{0 16 K21 W 0 "Bit 15 to 0 of K21"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 K22 W 0x0 "Data signal of K22" {{0 16 K22 W 0 "Bit 15 to 0 of K22"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x78 K23 W 0x0 "Data signal of K23" {{0 16 K23 W 0 "Bit 15 to 0 of K23"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 K31 W 0x0 "Data signal of K31" {{0 16 K31 W 0 "Bit 15 to 0 of K31"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x88 K32 W 0x0 "Data signal of K32" {{0 16 K32 W 0 "Bit 15 to 0 of K32"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 K33 W 0x0 "Data signal of K33" {{0 16 K33 W 0 "Bit 15 to 0 of K33"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x98 ROffset W 0x0 "Data signal of ROffset" {{0 10 ROffset W 0 "Bit 9 to 0 of ROffset"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 GOffset W 0x0 "Data signal of GOffset" {{0 10 GOffset W 0 "Bit 9 to 0 of GOffset"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0xa8 BOffset W 0x0 "Data signal of BOffset" {{0 10 BOffset W 0 "Bit 9 to 0 of BOffset"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0xb0 ClampMin W 0x0 "Data signal of ClampMin" {{0 8 ClampMin W 0 "Bit 7 to 0 of ClampMin"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0xb8 ClipMax W 0x0 "Data signal of ClipMax" {{0 8 ClipMax W 0 "Bit 7 to 0 of ClipMax"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0xc0 K11_2 W 0x0 "Data signal of K11_2" {{0 16 K11_2 W 0 "Bit 15 to 0 of K11_2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xc8 K12_2 W 0x0 "Data signal of K12_2" {{0 16 K12_2 W 0 "Bit 15 to 0 of K12_2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xd0 K13_2 W 0x0 "Data signal of K13_2" {{0 16 K13_2 W 0 "Bit 15 to 0 of K13_2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xd8 K21_2 W 0x0 "Data signal of K21_2" {{0 16 K21_2 W 0 "Bit 15 to 0 of K21_2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xe0 K22_2 W 0x0 "Data signal of K22_2" {{0 16 K22_2 W 0 "Bit 15 to 0 of K22_2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xe8 K23_2 W 0x0 "Data signal of K23_2" {{0 16 K23_2 W 0 "Bit 15 to 0 of K23_2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xf0 K31_2 W 0x0 "Data signal of K31_2" {{0 16 K31_2 W 0 "Bit 15 to 0 of K31_2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xf8 K32_2 W 0x0 "Data signal of K32_2" {{0 16 K32_2 W 0 "Bit 15 to 0 of K32_2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x100 K33_2 W 0x0 "Data signal of K33_2" {{0 16 K33_2 W 0 "Bit 15 to 0 of K33_2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x108 ROffset_2 W 0x0 "Data signal of ROffset_2" {{0 10 ROffset_2 W 0 "Bit 9 to 0 of ROffset_2"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x110 GOffset_2 W 0x0 "Data signal of GOffset_2" {{0 10 GOffset_2 W 0 "Bit 9 to 0 of GOffset_2"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x118 BOffset_2 W 0x0 "Data signal of BOffset_2" {{0 10 BOffset_2 W 0 "Bit 9 to 0 of BOffset_2"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x120 ClampMin_2 W 0x0 "Data signal of ClampMin_2" {{0 8 ClampMin_2 W 0 "Bit 7 to 0 of ClampMin_2"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x128 ClipMax_2 W 0x0 "Data signal of ClipMax_2" {{0 8 ClipMax_2 W 0 "Bit 7 to 0 of ClipMax_2"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 5.334 machine 64 combinational 0 latency 4679 II x}
...
source -notrace "D:/program/Xilinx2023/Vitis_HLS/2023.1/common/scripts/ipxhls.tcl"
