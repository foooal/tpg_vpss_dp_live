...
// 
// ==============================================================
#ifndef XBD_85A6_CSC_0_V_CSC_H
#define XBD_85A6_CSC_0_V_CSC_H
...
#include <stddef.h>
#endif
#include "xbd_85a6_csc_0_v_csc_hw.h"
...
typedef struct {
    u16 DeviceId;
    u64 Bd_85a6_csc_0_ctrl_BaseAddress;
} XBd_85a6_csc_0_v_csc_Config;
#endif

typedef struct {
    u64 Bd_85a6_csc_0_ctrl_BaseAddress;
    u32 IsReady;
} XBd_85a6_csc_0_v_csc;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XBd_85a6_csc_0_v_csc_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XBd_85a6_csc_0_v_csc_ReadReg(BaseAddress, RegOffset) \
