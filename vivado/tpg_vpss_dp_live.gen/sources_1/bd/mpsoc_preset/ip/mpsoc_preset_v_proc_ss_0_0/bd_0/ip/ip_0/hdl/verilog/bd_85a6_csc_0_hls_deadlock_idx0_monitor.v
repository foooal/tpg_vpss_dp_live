...
module bd_85a6_csc_0_hls_deadlock_idx0_monitor ( // for module bd_85a6_csc_0_v_csc_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 bd_85a6_csc_0_hls_deadlock_idx1_monitor bd_85a6_csc_0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
